    ...
    return (
        <>
            <main className="flex-grow">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <FadeIn className="flex flex-col gap-8">
                                ...
                                <h1 className="text-5xl font-black leading-[1.1] tracking-tight text-primary md:text-6xl lg:text-7xl">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <button className="flex h-14 min-w-[240px] items-center justify-center rounded-xl bg-primary text-white px-8 text-lg font-bold shadow-xl shadow-primary/20 transition-all hover:scale-105 active:scale-95">
                                        Solicitar acceso a Skool
                                    </button>
                                    <button className="flex h-14 items-center justify-center rounded-xl border-2 border-primary/10 px-8 text-lg font-bold text-primary hover:bg-black/5 transition-colors">
                ...
                {/* Benefits Section */}
                <section className="bg-soft-blue/10 px-6 py-20 lg:px-10">
                    <div className="mx-auto max-w-7xl">
                        <FadeIn className="mb-16 flex flex-col items-center text-center">
                            <h2 className="mb-4 text-3xl font-bold tracking-tight text-primary md:text-4xl">¿Por qué unirte a nosotros?</h2>
                            <div className="h-1.5 w-20 rounded-full bg-accent-blue"></div>
                        </FadeIn>

                        <div className="grid gap-8 md:grid-cols-3">
                            <FadeIn delay={0.1}>
                                <div className="group flex h-full flex-col gap-6 rounded-2xl bg-white border border-transparent p-8 transition-all hover:-translate-y-2 hover:shadow-xl hover:border-accent-blue/30">
                                    ...
                                    <div>
                                        <h3 className="mb-3 text-xl font-bold text-primary">Llamadas Q&A en vivo</h3>
                            ...
                            <FadeIn delay={0.2}>
                                <div className="group flex h-full flex-col gap-6 rounded-2xl bg-white border border-transparent p-8 transition-all hover:-translate-y-2 hover:shadow-xl hover:border-accent-blue/30">
                                    ...
                                    <div>
                                        <h3 className="mb-3 text-xl font-bold text-primary">Feedback honesto</h3>
                                        <p className="leading-relaxed text-slate-500">
                            ...
                            <FadeIn delay={0.3}>
                                <div className="group flex h-full flex-col gap-6 rounded-2xl bg-white border border-transparent p-8 transition-all hover:-translate-y-2 hover:shadow-xl hover:border-accent-blue/30">
                                    ...
                                    <div>
                                        <h3 className="mb-3 text-xl font-bold text-primary">Networking de alto nivel</h3>
                                        <p className="leading-relaxed text-slate-500">
                ...
                <section className="px-6 py-24 lg:px-10">
                    <FadeIn>
                        <div className="mx-auto max-w-4xl rounded-[2.5rem] bg-primary border px-8 py-16 text-center text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex justify-center relative z-10">
                                <button className="group flex min-w-[320px] cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-2xl bg-white px-10 py-6 text-xl font-black tracking-tight text-primary transition-all hover:scale-105 active:scale-100 shadow-xl">

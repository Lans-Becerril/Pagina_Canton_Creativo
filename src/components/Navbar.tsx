    ...
    return (
        <nav
            className={cn(
                ...
                scrolled
                    ? "py-2 bg-[#ffffff]/80 backdrop-blur-md border-[#cdd7e0]/20 shadow-sm"
                    : "py-4 bg-[#ffffff] border-transparent"
            )}
        >
            <div className="container mx-auto flex items-center justify-between px-4">
                ...
                <div className="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2 text-[#053040]">
                ...
                <div className="flex items-center gap-4">
                    <a
                        ...
                        className="bg-[#053040] text-[#ffffff] px-5 py-2 rounded-full text-sm font-bold hover:scale-105 transition-transform"
                    >
                        Contáctanos
                    </a>
                </div>
